...
INSERT INTO posts (writer, title) SELECT 'kim', '첫 게시글' WHERE NOT EXISTS (SELECT 1 FROM posts WHERE title = '첫 게시글');
INSERT INTO posts (writer, title) SELECT 'lee', '안녕하세요' WHERE NOT EXISTS (SELECT 2 FROM posts WHERE title = '안녕하세요');