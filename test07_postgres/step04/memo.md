# test07_postgres/step04/memo.md

### Writable DB 와 Readonly DB(replica) 만들어서 테스트 하기
...
# replica db container 실행하기 (port : 5433)
docker run -d \
    -p 5433:5432 \
...
# pg-main & pg-replica 컨테이너 잘 생성되었느지 확인 
docker container ls
