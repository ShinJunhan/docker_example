# /test08_overlay/memo3.md

### custom overlay network 만들어 보기 10.10.10.0/24

#### bridge switch 추가, host 를 통해서 internet으로 나갈 수 있도록 설정 추가
...
# host os 커널에게 가상 페킷 (ip forward ) 허용하도록 설정(docker 를 설치하면서 이미 되어 있다)
# sudo sysctl -w net.ipv4.ip_forward=1

# 외부로 나갈때 host 의 공인 ip (172.16.8.200) 나가도록 하기(NAT)
# -j MASQUERADE (host 의 가면을 쓰고 jump 하도록)
...
ping 10.10.10.2 -c 5
ping 8.8.8.8 -c 5  # internet 가능 여부 확인
